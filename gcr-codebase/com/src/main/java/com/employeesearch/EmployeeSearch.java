...
public class EmployeeSearch {
	public static void main(String[] args) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader("/Users/apple/Desktop/java programming workspace/gcr-codebase/com/src/main/resources/employees.csv"))) {
			String line;
			boolean found = false;
